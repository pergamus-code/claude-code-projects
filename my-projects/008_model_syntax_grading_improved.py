...
[
{
    ...
    "souliton_criteria": "Key criteria for evaluating the solution."
},
...additional
]
```
...
"""
    ...
    text = chat(messages, system= "Output only json")
    return text
...
{{
    ...
    eval_text = chat(messages, system="output should be in json format")
...
* Do not call on any models within the code to solve the solution
* Do not add any comments or commentary or explanation
* * NO FLUFF *
"""
    messages = []
    add_user_message(messages, prompt)
    output = chat(messages, system="output should be code only")
    return output
...
def run_test_case(test_case):
    ...
    model_score = parsed_eval["score"]
    reasoning = parsed_eval["reasoning"]
    print(f"Model score: {model_score}")                                #### PRINT

    ### SYNTAX GRADER  ##### 
    syntax_score = grade_syntax(clean_output, test_case)
    print(f"Syntax score: {syntax_score}")                              #### PRINT
